    ...
    <main>
      <section className="section-register">
        <div className="section-register__container">
          <h1 className="section-register__header">
            Каршеринг в любой точке России
          </h1>
          <p className="section-register__content">
        ...
        <div className="section-info__container">
          <div className="section-info__list">
            <div className="section-info__list-item">
              <img
                className="section-info__list-image"
                src={listPicture01}
                alt="Иллюстрация - Аренда напрямую от владельцев"
              />
              <div className="section-info__list-container">
                <h2 className="section-info__list-header">
                  Аренда напрямую от владельцев
                </h2>
                <p className="section-info__list-content">
            ...
            <div className="section-info__list-item">
              <img
                className="section-info__list-image"
                src={listPicture02}
                alt="Иллюстрация - Автомобили на любой вкус"
              />
              <div className="section-info__list-container">
                <h2 className="section-info__list-header">
                ...
                <p className="section-info__list-content">
                  Вы всегда можете подобрать автомобиль любого класса от
                  бюджетных моделей до премиум-класса и спорткаров.
                </p>
              </div>
            </div>
            <div className="section-info__list-item">
              <img
                className="section-info__list-image"
                src={listPicture03}
                alt="Иллюстрация - Гарантия честной аренды"
              />
              <div className="section-info__list-container">
                <h2 className="section-info__list-header">
                ...
                <p className="section-info__list-content">
                  Общение и оплата происходит через наш сервис, что
                  предотвращает вас от обмана.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="section-rent">
        <div className="section-rent__container">
          ...
          <ul className="section-rent__list">
            <li className="section-rent__list-item" data-number="1">
              Выберите автомобиль
            </li>
            <li className="section-rent__list-item" data-number="2">
              Забронируйте дату и время
            </li>
            <li className="section-rent__list-item" data-number="3">
              Получите автомобиль
            </li>
          </ul>
        </div>
      ...
      <section className="section-tryout">
        <div className="section-tryout__container">
          <img
            className="section-tryout__image"
            src={tryoutPicture}
            alt="Иллюстрация - Попробуйте"
          />
